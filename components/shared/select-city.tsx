...
export const SelectCity = React.forwardRef<HTMLDivElement, SelectCityProps>(({ value, onChange }, ref) => {
  const locations = [
    ...
    <Select value={value} onValueChange={onChange}>
      ...
      <SelectContent ref={ref}>
        {locations.sort().map((location) => (
          <SelectItem key={location} value={location} className="hover:cursor-pointer">
            {location}
          </SelectItem>
        ))}
      </SelectContent>
